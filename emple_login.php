...
<div id="main-content">
  ...
  <h1>Login</h1>
  <p class="subtitle">Inicie una nueva sesión con su usuario y contraseña.</p>

<div id="login-form">
  <form class="astein-form" action="empleado_login_check.php" method="post">
    ...
    <input class="save-changes" type="submit" action="empleado_login_check.php" method="post" tabindex=1 value="login">
