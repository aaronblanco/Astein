...
<p>
  ...
  Astein está domiciliada en la Carretera de Almeria 86 Oficina 5, con CIF (número correspondiente), correo.numero. Inscrita en el Registro Mercantil de Huercal de Almeria, Vol. (número correspondiente), Folio (número correspondiente), Hoja (número correspondiente), Inscripción (número correspondiente).  //PEDiR REGISTRO MERCANTIL
  <br><br>
  En la web www.astein.net  hay una serie de contenidos de carácter informativo sobre las actividades que realizamos, intermediamos entre el cliente y la empresa que facilita la oferta publicada, buscando satisfacer y facilitar la contratación de estas ofertas a nuestros clientes.
  <br><br>
  ...
  En cumplimiento de lo dispuesto en la Ley Orgánica 15/1999, de 13 de Diciembre, de Protección de Datos de Carácter Personal (LOPD) se informa al usuario que todos los datos que nos proporcione serán incorporados a un fichero, creado y mantenido bajo la responsabilidad de Astein.
  <br><br>
  ...
  <br><br>
  Para ejercer sus derechos de oposición, rectificación o cancelación deberá dirigirse a la sede de la empresa Carretera de Almeria 86 Oficina 5, escribirnos al siguiente correo dptoinformatico@astein.net o llámanos al 643563593.
  <br><br>
  ...
  <br><br>
  Ser usuario de la web de www.astein.net implica que reconoce haber leído y aceptado las presentes condiciones y lo que las extienda la normativa legal aplicable en esta materia. Si por el motivo que fuere no está de acuerdo con estas condiciones no continúe usando esta web.
  Cualquier tipo de notificación y/o reclamación solamente será válida por notificación escrita y/o correo certificado.
  <br><br>

  <h3>RESPONSABILIDADES</h3>
  Astein no se hace responsable de la información y contenidos almacenados en foros, redes sociales o cualesquier otro medio que permita a terceros publicar contenidos de forma independiente en la página web del prestador.
  <br><br>
  Sin embargo, teniendo en cuenta los art. 11 y 16 de la LSSI-CE, Astein se compromete a la retirada o en su caso bloqueo de aquellos contenidos que pudieran afectar o contravenir la legislación nacional o internacional, derechos de terceros o la moral y el orden público.
  <br><br>
  ...
  <br><br>
  Así mismo, Astein se reserva el derecho a actualizar, modificar o eliminar la información contenida en su página web, así como la configuración o presentación del mismo, en cualquier momento sin asumir alguna responsabilidad por ello.
  <br><br>
  Le comunicamos que cualquier precio que pueda ver en nuestra web será solamente orientativo. Si el usuario desea saber con exactitud el precio o si el producto en el momento actual cuenta con alguna oferta de la cual se puede beneficiar ha de llamar o acudir a nuestra oficina.
  <br><br>

  <h3>PROPIEDAD INTELECTUAL E INDUSTRIAL</h3>
  Astein es titular de todos los derechos sobre el software de la publicación digital así como de los derechos de propiedad industrial e intelectual referidos a los contenidos que se incluyan, a excepción de los derechos sobre productos y servicios de carácter público que no son propiedad de esta empresa.
  <br><br>
  Ningún material publicado en esta web podrá ser reproducido, copiado o publicado sin el consentimiento por escrito de Astein.  //No se si quitarlo
  <br><br>
  Toda la información que se reciba en la web, como comentarios, sugerencias o ideas, se considerará cedida a Astein de manera gratuita. No debe enviarse información que NO pueda ser tratada de este modo.
  <br><br>
  Todos los productos y servicios de estas páginas que NO son propiedad de Astein son marcas registradas de sus respectivos propietarios y son reconocidas como tales por nuestra empresa. Solamente aparecen en la web de Astein a efectos de promoción y de recopilación de información. Estos propietarios pueden solicitar la modificación o eliminación de la información que les pertenece.
  <br><br>

  <h3>LEY APLICABLE Y JURISDICCIÓN</h3>
  Las presentes condiciones generales se rigen por la legislación española. Para cualquier litigio que pudiera surgir relacionado con el sitio web o la actividad que en él se desarrolla serán competentes Juzgados de Almería, renunciando expresamente el usuario a cualquier otro fuero que pudiera corresponderle.
  <br><br>
